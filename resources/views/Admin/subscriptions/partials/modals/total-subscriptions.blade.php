...
<div id="totalSubscriptionsModalTemplate" style="display: none;">
    <div dir="rtl">
        <!-- Workshop Selection -->
        <div class="mb-4">
            <label for="total_subscriptions_workshop_id" class="form-label">اختر الورشة <span class="text-danger">*</span></label>
        ...
        <div id="total_subscriptions_summary" style="display: none;" class="mb-4">
            <div class="alert alert-info" style="background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 8px; padding: 1.5rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        <div style="color: #94a3b8; font-size: 0.9rem; margin-bottom: 0.25rem;">الإجمالي:</div>
                        <div style="color: #fff; font-weight: 600; font-size: 1.2rem;" id="total_subscriptions_total_amount">-</div>
                    </div>
                    <div>
                        <div style="color: #94a3b8; font-size: 0.9rem; margin-bottom: 0.25rem;">المشتركون:</div>
        ...
        <!-- Table Section -->
        <div id="total_subscriptions_table_section" style="display: none;">
            <div class="table-responsive" style="max-height: 50vh; overflow-y: auto;">
                <table class="table" style="color: #fff; margin: 0;">
                    ...
                    <tbody id="total_subscriptions_table_body">
