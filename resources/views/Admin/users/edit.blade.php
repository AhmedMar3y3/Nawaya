...
@section('main')
<div class="edit-user-container" dir="rtl">
    <!-- Page Header -->
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="page-title">تعديل المستخدم</h1>
                <p class="page-subtitle">تعديل معلومات المستخدم: {{ $user->name }}</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age" value="{{ old('age', $user->age) }}" min="1" max="120" required>
                        @error('age')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('section') is-invalid @enderror" id="section" name="section" required>
                            @foreach($filterOptions['sections'] as $section)
                                <option value="{{ $section->value }}" {{ old('section', $user->section->value) === $section->value ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('start_level') is-invalid @enderror" id="start_level" name="start_level" required>
                            @foreach($filterOptions['levels'] as $level)
                                <option value="{{ $level->value }}" {{ old('start_level', $user->start_level->value) === $level->value ? 'selected' : '' }}>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('exam_date') is-invalid @enderror" id="exam_date" name="exam_date" value="{{ old('exam_date', $user->exam_date?->format('Y-m-d')) }}">
                        @error('exam_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($user->image)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $user->image) }}" alt="Current Image" class="current-image">
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_notify" name="is_notify" value="1" {{ old('is_notify', $user->is_notify) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="completed_info" name="completed_info" value="1" {{ old('completed_info', $user->completed_info) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="questionnaire_taken" name="questionnaire_taken" value="1" {{ old('questionnaire_taken', $user->questionnaire_taken) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-3">
                <a href="{{ route('admin.users.show', $user->id) }}" class="btn-cancel">إلغاء</a>
